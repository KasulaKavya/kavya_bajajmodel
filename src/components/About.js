            ...
            <div className="container-fluid">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-4">
                        <div className="card border-0">
                            <div className="card-body">
                                <h4 className="p-1 about_txt"> <FontAwesomeIcon icon={faHeart} /> Passion </h4>
                    ...
                    <div className="col-lg-4">
                        <div className="card border-0">
                            <div className="card-body">
                                <h4 className="p-1 about_txt"> <FontAwesomeIcon icon={faLightbulb} /> Creativity</h4>
                    ...
                    <div className="col-lg-4">
                        <div className="card border-0">
                            <div className="card-body">
                                <h4 className="p-1 about_txt "> <FontAwesomeIcon icon={faStar} /> Quality</h4>
