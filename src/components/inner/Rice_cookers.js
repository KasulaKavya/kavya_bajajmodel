...
const url=" http://localhost:3041/rice_cookers"


const Rice_cookers= ()=>
{

    const [rice_cookers,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Rice Cookers - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>
   
                            {
                                rice_cookers.map((m,rc)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={rc}>
