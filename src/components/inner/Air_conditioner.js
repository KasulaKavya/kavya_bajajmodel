...
const url=" http://localhost:3041/air_conditioners"


const Air_conditioner= ()=>
{

    const [air_conditioners,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Air Conditioners - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>

                            {
                                air_conditioners.map((m,ac)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={ac} >
                                                ...
                                                <div className="row g-0">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="card-body">
                                                            ...
                                                            <Link className="btn btn-outline-danger px-3 buy-btn w-25 " 
...
export default Air_conditioner