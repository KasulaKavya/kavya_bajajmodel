...
const url=" http://localhost:3041/laptop_accessories"


const Laptops_accessories= ()=>
{

    const [laptop_accessories,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                            ...
                            <h4 className="mx-4 my-2"> Laptop Accessories - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>
                            
                            {
                                laptop_accessories.map((m,la)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={la}>
                                                ...
                                                <div className="row g-0">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="card-body">
                                                            ...
                                                            <Link className="btn btn-outline-danger px-3 buy-btn " to="/add_to_cart"
...
export default Laptops_accessories