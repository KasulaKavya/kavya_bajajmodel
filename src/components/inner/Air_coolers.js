...
const url=" http://localhost:3041/air_coolers"


const Air_coolers= ()=>
{

    const [air_coolers,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Air Coolers - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>

                            {
                                air_coolers.map((m,acc)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={acc}>
