...
const url=" http://localhost:3041/smart_phones"


const Smart_phones = ()=>
{

    const [smart_phones,setState]=useState([])
            ...
            <div className="container-fluid mx-4 ">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        {
                            smart_phones.map((m,sp)=>
                            {

                                return(<>

                                    {/* 2nd column */}
                                    <div className="col-12 " key={sp}>

                                        <h4 className="mx-4 my-2"> Laptops - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>

                                        <div className="card border-0 ">
                                            <div className="row g-0">
                                                <div className="col-md-3">
                                                    <img src={m.image} className="w-100 " alt="a" data-bs-dismiss="modal" />
