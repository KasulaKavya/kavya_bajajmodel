...
const url=" http://localhost:3041/wasing_machines"


const Washing_machines= ()=>
{

    const [wasing_machines,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10">
                        ...
                        <h4 className="mx-4 my-2"> Washing Machines - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>
    
                            {
                                wasing_machines.map((m,wm)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 vl" key={wm}>
...
export default Washing_machines