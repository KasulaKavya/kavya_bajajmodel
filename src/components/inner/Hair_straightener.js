...
const url=" http://localhost:3041/hair_straightener"


const Hair_straightener= ()=>
{

    const [hair_straightener,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Hair Straightener - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>

                            
                            {
                                hair_straightener.map((m,hs)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={hs}>
...
export default Hair_straightener