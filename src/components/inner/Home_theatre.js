...
const url=" http://localhost:3041/home_theatre"


const Home_theatre= ()=>
{

    const [home_theatre,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Home Theatre - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>
  
                            {
                                home_theatre.map((m,ht)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={ht}>
