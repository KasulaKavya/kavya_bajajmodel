...
const url=" http://localhost:3041/induction_cooktop"


const Induction_cooktop= ()=>
{

    const [induction_cooktop,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Induction Cooktops - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>

                            {
                                induction_cooktop.map((m,ic)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={ic}>
...
export default Induction_cooktop