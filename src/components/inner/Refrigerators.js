...
const url=" http://localhost:3041/refrigerator"


const Refrigerators= ()=>
{

    const [refrigerator,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Refrigerators - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>
  
                            {
                                refrigerator.map((m,rf)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={rf}>
