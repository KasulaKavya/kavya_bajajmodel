...
const url=" http://localhost:3041/smart_watches"


const Smart_watches= ()=>
{

    const [smart_watches,setState]=useState([])
            ...
            <div className="container-fluid mx-4">
                <div className="row my-3 ">
                    ...
                    <div className="col-lg-10 vl">
                        ...
                        <h4 className="mx-4 my-2"> Smart watches - <small style={{fontSize: "20px", fontWeight: "400"}} >Best Prices</small>  </h4>

                            {
                                smart_watches.map((m,sw)=>
                                {

                                    return(<>

                                        {/* 2nd column */}
                                        <div className="col-12 " key={sw}>
